...
public class NewObject {
    ...
    public static void newPlayer(Player player) {
        try (PreparedStatement newPlayer = SQLDatabase.connection.prepareStatement("INSERT INTO players (UUID, prefix, suffix, chatColor, balance, flyTime, name, online, playTime, staffMode, staffInventory, staffArmor, vanished, secret) VALUES ( UNHEX(?), '', '', '', 0, 0, ?, true, 0, false, '', '', false, '')")) {
