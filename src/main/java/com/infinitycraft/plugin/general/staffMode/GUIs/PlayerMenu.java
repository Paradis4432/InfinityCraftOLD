...
public class PlayerMenu {
    public static void generate(Player player, ItemStack skull) {
        ...
        takeAction = ItemCreator.createItem(Material.BEDROCK, 1, "Take Action", "Ban, Kick, or take any other action on this player.");
        // Edit Skull
        ...
        items.put(skull, 4);
        // Create Inventory
        inv = CreateInventory.createCustomInventory(null, 6, "Viewing: " + skullOwner.getName(), Fillers.filler, items);
